...
import (
	...
	"github.com/dexter0195/oauth2-proxy-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "39c4d7e1.oauth2proxy-operator.dexter0195.com",
	...
	if err = (&controllers.OAuth2ProxyReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("oauth2proxy-controller"),
